        ...
        <div className="space-y-4 text-gray-600">
          ...
          <div className="bg-gray-50 p-4 rounded-xl space-y-4">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-sm space-y-1 ml-2">
                <li><strong>Dimensions:</strong> Calculated as a single large open central box (4 side panels, no top/bottom).</li>
        ...
        <div className="space-y-4 text-gray-600">
          ...
          <div className="bg-gray-50 p-4 rounded-xl space-y-3">
            ...
            <ul className="list-disc list-inside text-sm space-y-1 ml-2">
              ...
              <li><strong>Hardware:</strong> Buffers (₹7/pc), Nuts (₹5/pc), Butterfly brackets (₹12.5/pc), Clamps (₹10/pc).</li>
            </ul>
          </div>
        </div>
      </div>
